-- # THIS IS NOT MADE BY ME! It is a modified version of Sense ESP Library
-- # Credits to Sirius for this
...
function EspObject:Construct()
	...
	self.drawings = {
		...
		visible = {
			...
			boxOutline = self:create("Square", { Thickness = 4, Visible = false }),
			box = self:create("Square", { Thickness = 2, Visible = false }),
